...
import { Interface, keccak256, toUtf8Bytes } from 'ethers' with { imports: 'bare-node-runtime/imports' }
...
export async function escrowDeposit (alertId, amount, escrowAddressOverride) {
  ...
  console.log(`[wallet] Approving escrow ${escrowAddress} for ${amount} USDT...`)
